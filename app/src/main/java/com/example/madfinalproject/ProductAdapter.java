...
public class ProductAdapter extends ArrayAdapter {
    ...
    int Layout_Id;
    Context mContext;
    ArrayList<ProductsListtype> ListOfProducts;

    public ProductAdapter(Context context, ArrayList<ProductsListtype> list) {
        super(context, 0);
        mContext = context;
        Layout_Id = R.layout.product_layout;
        ListOfProducts = list;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView name = (TextView) view.findViewById(R.id.txtprice);
        TextView price = (TextView) view.findViewById(R.id.txtquantity);
        TextView quantity = (TextView) view.findViewById(R.id.txtname);
